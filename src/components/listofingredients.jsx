...
<main className="flex items-center md:justify-center">
  { props.ingredientsList.length > 0 ? <section className="w-full"> 
            <h2 className="font-bold pb-2 flex items-center justify-center lg:text-[25px]">Ingredients you have:</h2>
            <ul aria-live="polite" className="flex items-center bg-[#F0EFEB] pb-10 rounded-lg flex-col text-center justify-center pt-10 space-y-10
